    ...
    <>
            ...
            <div className="hidden md:block relative w-full max-w-full overflow-hidden py-16">
                <div className="flex flex-row justify-between items-center mb-3 px-3 md:px-12">
                    <h2 className="poppins-bold text-[42px] leading-[110%] tracking-normal text-center align-bottom">
                        Recommended activities for your child 
                    </h2>
                    <p className="poppins-semibold text-[20px] text-[#0D53E0] hover:cursor-pointer z-20">View All</p>
                </div>

                {/* Left Arrow */}
                <div className="absolute left-4 top-1/2 z-20 -translate-y-1/2 hover:cursor-pointer ">    
                        <button
                ...
                {/* Right Arrow */}
                <div className="absolute right-4 top-1/2 z-20 -translate-y-1/2 hover:cursor-pointer">
                        <button
                ...
                <div className="absolute left-0 top-0 w-30 h-full bg-gradient-to-r from-white/60 to-transparent z-[1]" />

                <div
                    ref={scrollContainerRef}
                    className="flex overflow-x-auto scrollbar-hide snap-x snap-mandatory px-8 pb-4 relative scroll-smooth gap-6"
                ...
                <div className="absolute right-0 top-0 w-30 h-full bg-gradient-to-l from-white/60 to-transparent z-[1]" />
            </div>
            ...
            <div className="block md:hidden relative w-full max-w-full overflow-hidden py-8 px-3 ">
                <div className="relative w-full max-w-full overflow-hidden py-8 px-3 rounded-2xl border border-[#E4E8F4] shadow-[0_4px_32px_0_#00000014] bg-white">
                    <h1 className="poppins-semibold text-[#06241B] text-[22px] leading-[110%] capitalize text-center mb-6">
                        Recommended<br/> activities for your child
                    </h1>
